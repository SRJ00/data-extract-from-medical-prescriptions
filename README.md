...
| **`model_evaluation.md`** | 📊 **Evaluation Strategy & Key Insights**<br>Explains the strategy used to evaluate messy handwritten prescriptions with unclear handwriting and mixed content. |
